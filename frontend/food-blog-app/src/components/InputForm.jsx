...
export default function InputForm({ setIsOpen }){
    ...
    const handleOnSubmit=async(e)=>{
        ...
        //nous vérifions tout d'abord si la connexion est vrai ou fausse: si vrai on dit qu'il s'agit de inscription , sinon connexion
        let endpoint=(isSignUp) ? "signUp" : "login"
        await axios.post(`http://localhost:5000/${endpoint}` ,{email,password}).then((res)=>{
            //on stocke le jeton et l'user dans le stockage locale

...
export default function Home(){
  ...
  const addRecipe=()=>{
    ...
    if(token){
      //si le jeton est présent on naviguera vers le form d'ajout de recette
        navigate("/addRecipe")
    }
    else{ 
      //sinon cela signifie que l'utilisateur n'est pas connecté, et nous allons ouvrir la fenetre contextuel de login ou sign up 
      setIsOpen(true)
    }
